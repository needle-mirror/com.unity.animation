    ...
    public class ExposeTransformPerformanceTests : AnimationTestsFixture
    {
        ...
        public void EvaluateReadExposedTransformSystemWithAllEntityWithReadAccess(int boneCount)
        {
            ...
            Measure.Method(
                ...
                .Definition("EvaluateReadExposedTransformSystemWithAllEntityWithReadAccess")
                .WarmupCount(100)
        ...
        public void EvaluateReadExposedTransformSystemWithHalfEntityWithReadAccess(int boneCount)
        {
            ...
            Measure.Method(
                ...
                .Definition("EvaluateReadExposedTransformSystemWithHalfEntityWithReadAccess")
                .WarmupCount(100)
                .MeasurementCount(500)
                .Run();
        }
        ...
        public void EvaluateReadExposedTransformSystemWithNoEntityWithReadAccess(int boneCount)
        {
            ...
            Measure.Method(
                ...
                .Definition("EvaluateReadExposedTransformSystemWithNoEntityWithReadAccess")
                .WarmupCount(100)
                .MeasurementCount(500)
                .Run();
        }
        ...
        public void EvaluateWriteExposedTransformSystemWithAllEntityWithWriteAccess(int boneCount)
        {
            ...
            Measure.Method(
                ...
                .Definition("EvaluateWriteExposedTransformSystemWithAllEntityWithWriteAccess")
                .WarmupCount(100)
                .MeasurementCount(500)
                .Run();
        }
        ...
        public void EvaluateWriteExposedTransformSystemWithHalfEntityWithWriteAccess(int boneCount)
        {
            ...
            Measure.Method(
                ...
                .Definition("EvaluateWriteExposedTransformSystemWithHalfEntityWithWriteAccess")
                .WarmupCount(100)
                .MeasurementCount(500)
                .Run();
        }
        ...
        public void EvaluateWriteExposedTransformSystemWithNoEntityWithWriteAccess(int boneCount)
        {
            ...
            Measure.Method(
                ...
                .Definition("EvaluateWriteExposedTransformSystemWithNoEntityWithWriteAccess")
                .WarmupCount(100)
                .MeasurementCount(500)
                .Run();
        }
