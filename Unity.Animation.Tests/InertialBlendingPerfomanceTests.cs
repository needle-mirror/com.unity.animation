...
namespace Unity.Animation.Tests.InertialMotionBlending
{
        ...
        public void Test_IntertializeVector()
        {
            ...
            unsafe
            {
                ...
                Measure.Method(() =>
                {
                    ...
                    {
                        BurstedCore.EvaluateInertializeVector.Invoke(ref secondLast, ref last, ref current, deltaTime, time,
        ...
        public void Test_IntertializeQuaternion()
        {
            ...
            unsafe
            {
                ...
                Measure.Method(() =>
                {
                    for (int i = 0; i < reps; ++i)
                    {
                        BurstedCore.EvaluateInertializeQuaternion.Invoke(ref secondLast, ref last, ref current,
                            deltaTime, time,
                            outDirectionPtr, outCoefficientsPtr);
                    }
                })
        ...
        public void Test_IntertializeFloat()
        {
            ...
            unsafe
            {
                ...
                Measure.Method(() =>
                {
                    for (int i = 0; i < reps; ++i)
                    {
                        BurstedCore.EvaluateInertializeFloat.Invoke(ref secondLast, ref last, ref current,
                            deltaTime, time,
                            outCoefficientsPtr);
                    }
                })
